  document.addEventListener("DOMContentLoaded", function () {
    ...
    const slideItems = document.querySelectorAll("#slide-numbers .item");

    function updateSlideNumbersVisibility() {
      if (
        loginPage &&
        ...
        slideItems.forEach((item) => {
          item.classList.add("hide-slide-number");
        });
      } else {
        slideItems.forEach((item) => {
          item.classList.remove("hide-slide-number");
        });
      }
    }

    updateSlideNumbersVisibility();
  });
